...
const AddProductModal = (props) => {
  ...
  const addItem = async () => {
    const {name, qty, description, type, price, os, cpu,  gpu, ram, motherboard, storage} = state;
    

    await Axios.post("/api/products", {pc_name: name, qty, description, type, price, os, cpu, graphic_card: gpu, ram, motherboard, storage})
      .then((res) => {
        // setState({ id: res})
        console.clear()
